...
uint16_t pb0_time;   // Count of milliseconds that PB0 has been held for
uint16_t pb1_time;   // Count of milliseconds that PB1 has been held for
uint16_t pb2_time;   // Count of milliseconds that PB2 has been held for
