...
// First defined as extern in header, initializing to zero here
uint8_t pb_stat = 0;

uint8_t pb_manager_flags = 0;   // Bit-field of flags to be used by button manager logic
